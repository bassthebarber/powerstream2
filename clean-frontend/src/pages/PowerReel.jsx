...
import { getReels, postReel, likeReel, commentReel } from '../services/api.js';
...
export default function PowerReel() {
  ...
  const handleViewReel = async (reelId) => {
    try {
      // backend view tracking can be added here once /reels/:id/view exists
      void reelId;
    } catch (err) {
  ...
  const handlePostComment = async () => {
    ...
    try {
      ...
      await commentReel(reelId, commentText);
    } catch (err) {
