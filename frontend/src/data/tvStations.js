...
export const TV_STATIONS = {
  ...
  stations: [
    ...
    },
    {
      id: 'lynny-redd-tv',
      slug: 'lynny-redd-tv',
      route: '/tv/lynny-redd-tv',
      name: 'Lynny Redd TV',
      title: 'Lynny Redd TV',
      tagline: 'Independent culture and exclusive drops.',
      description: 'Independent culture, music, and exclusive content from Lynny Redd.',
      logo: '/logos/tv/lynny-redd-tv.png',
      coverImage: '/images/tv-default-cover.jpg',
      theme: 'music',
      category: 'music',
      features: ['live', 'vod', 'upload'],
    ...
    },
    {
      ...
      name: 'Gas God TV',
      title: 'Gas God TV',
      tagline: 'High-energy street culture and originals.',
      description: 'High-energy street culture, music, and original content from Gas God.',
